...
class DownloadTiktokV2 extends StatefulWidget {
  @override
  _DownloadTiktokV2State createState() => _DownloadTiktokV2State();
}

class _DownloadTiktokV2State extends State<DownloadTiktokV2> {
  ...
  void _submitUrl() async {
    ...
    var response = await ApiService.fetchTikTokData(enteredUrl, "v2");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("TikTok Downloader V2", style: GoogleFonts.poppins()),
